...
# Classification of ZDNet news items, 2005-2013
# N = ... items with keywords "DADVSI" or "HADOPI"
...
rm(list = ls())
setwd("~/Desktop/zdnet-scraper/zdnet.corpus")
d = dir()
...
# save
sink("../zdnet.corpus.keywords.txt")
freq
sink()
...
q
ggsave("../zdnet.mediagraph.pdf", width = 10, height = 7.5, unit = "in")

write.csv(z, "../zdnet.corpus.classes.txt")
# 2013-05-20
